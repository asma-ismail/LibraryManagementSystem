            ...
            <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                            ...
                            <form class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <form action="{{ route('admin.subscribers') }}" method="GET">
                                        <input type="text" id="simple-search" placeholder="Search for Subscribers"
                                            name="s" required=""
                                    ...
                                    <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <button type="button"
                                                    data-modal-target="delete-modal{{ $subscriber->id }}"
                                                    data-modal-toggle="delete-modal{{ $subscriber->id }}"
                                        ...
                                        <!-- Delete Modal -->
                                        <div id="delete-modal{{ $subscriber->id }}" tabindex="-1"
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div class="p-6 text-center">
                                                        ...
                                                        <h3
                                                            ...
                                                            delete
                                                            this Subscriber {{ $subscriber->id }} ?</h3>
                                                        <form
                                                            action="{{ route('admin.subscriber.remove', [$subscriber->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')

                                                            <button data-modal-toggle="delete-modal{{ $subscriber->id }}"
                                                                type="submit"
                    ...
                    <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                        ...
                        @if (count($subscribers) == 0 || $subscribers == null)
