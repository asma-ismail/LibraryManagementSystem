                ...
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center">
                            <label for="simple-5search" class="sr-only">Search</label>
                            <div class="relative w-full">
                                ...
                                <form action="{{ route('admin.books.index') }}" method="GET">
                                    <input type="text" id="simple-search" placeholder="Search for Books"
                                        name="s" required=""
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="p-4">Genre</th>
                                <th scope="col" class="p-4">Language</th>
                                <th scope="col" class="p-4">Author</th>
                                <th scope="col" class="p-4">Publisher</th>
                                <th scope="col" class="p-4">Date of publishing</th>
                                ...
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <th scope="row"
                                        ...
                                        <div class="flex items-center mr-3">
                                            <img src="{{ $book->cover }}" alt="Book" class="h-8 w-auto mr-3">
                                            {{ $book->id }}
                                        </div>
                                    </th>
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <button type="button"
                                                ...
                                                <a href="{{ route('admin.books.show', ["$book->id"]) }}">Preview</a>
                                            </button>
                                            <button type="button"
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-6 text-center">
                                                    ...
                                                    <h3
                                                        ...
                                                        delete
                                                        this Book {{ $book->id }} ?</h3>
                                                    <form action="{{ route('admin.books.destroy', [$book->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')

                                                        <button data-modal-toggle="delete-modal{{ $book->id }}"
                                                            type="submit"
    ...
    <div id="drawer-read-product-advanced"
        ...
        <dl class="sm:mb-5">
            ...
            <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Standard glass ,3.8GHz 8-core
                ...
                5500
                XT with 8GB of GDDR6 memory, 256GB SSD storage, Gigabit Ethernet, Magic Mouse 2, Magic Keyboard - US.
            </dd>
        </dl>
