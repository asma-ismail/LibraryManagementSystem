<x-app-layout>
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen bg-white dark:bg-gray-900">
        ...
        <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Et fugiat aliquip
            voluptate est et pariatur id qui. Dolor exercitation elit magna eu aliquip non pariatur eiusmod laborum
            sunt. Duis ad veniam tempor et incididunt do nisi veniam et nulla dolor mollit amet.
        </p>
        <div class="grid grid-cols-6 gap-3 mt-8">
            <div
                class="w-full  space-x-4 col-span-2 max-w-sm mt-8 p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Bronze plan</h5>
                ...
                @if (Auth::check())
                    ...
                    @else
                        @auth
                            <form action="{{ route('zain.payment') }}" method="POST">
                            @endauth
                            <button type="submit"
            ...
            <div
                class="w-full max-w-sm col-span-2 p-4 mb-3 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Gold plan</h5>
                <div class="flex items-baseline text-gray-900 dark:text-white">
                    <span class="text-3xl font-semibold">$</span>
            ...
            <div
                class="w-full max-w-sm col-span-2 p-4 bg-white mt-7 border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Silver plan</h5>
                <div class="flex items-baseline text-gray-900 dark:text-white">
                    <span class="text-3xl font-semibold">$</span>
                    <span class="text-5xl font-extrabold tracking-tight">34</span>
                    <span class="ms-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                </div>
                <ul role="list" class="space-y-5 my-7">
                    <li class="flex items-center">
