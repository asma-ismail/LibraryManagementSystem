...
<body class="font-sans antialiased">
    ...
    <div id="newsletter-banner" tabindex="-1"
        ...
        <div class="flex items-center flex-shrink-0 w-full mx-auto sm:w-auto">
            <form class="flex flex-col items-center w-full md:flex-row" action="{{ route('subscribe') }}"
                method="POST">
                @csrf
                <label for="email"
                    class="flex-shrink-0 mb-2 me-auto text-sm font-medium text-gray-500 md:mb-0 md:me-4 dark:text-gray-400 md:m-0">Get
                    Latest Updates About Our Library!</label>
        ...
        <div class="mx-auto w-full max-w-screen-xl">
            ...
            <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a
                        href="https://flowbite.com/">My Bookstore™</a>. All Rights Reserved.
                </span>
